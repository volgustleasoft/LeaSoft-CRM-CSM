...
class DateTimeValidate implements Rule
{
    ...
    private function getErrors() {
        return [
            'invalidDate' => 'You selected an invalid date',
            'endBeforeStart' => 'Start time is selected later than end time',
            'lessMinimumLength' => 'The meeting has a minimum length of ' . $this->minimumLength . 'minutes',
            'maximumFutureDate' => 'The appointment must be no later than ' . $this->meetingLimitMonthsAhead .' take place months later,'
       ];
    }
}
